...
QT_INIT_METAOBJECT const QMetaObject choose::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_choose.data,
    qt_meta_data_choose,
    qt_static_metacall,
    nullptr,
    nullptr
